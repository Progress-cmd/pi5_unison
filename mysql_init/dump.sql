...
--
-- Hôte : db
-- Généré le : jeu. 09 avr. 2026 à 15:26
...
INSERT INTO `users` (`id`, `username`, `email`, `password-hash`, `time-listened`, `reset_token`, `reset_token_expires`) VALUES
(1, 'Francis', 'haspotfrancis@gmail.com', '$2y$10$8VkACGqaagoHZK72df0hSeBShrEq8YumGIb9a2V/d2oMqqj1j6Vn6', 0, NULL, NULL),
(2, 'Cassandre', 'cassandrejosso@gmail.com', '', 0, NULL, NULL);
...
--
-- Index pour la table `artist__genre`
--
ALTER TABLE `artist__genre`
...
--
ALTER TABLE `artist__genre`
  ADD CONSTRAINT `artist__genre_artists_id_fk` FOREIGN KEY (`artist_id`) REFERENCES `artists` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
